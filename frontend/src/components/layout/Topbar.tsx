                  ...
                  {recentUnreadEmails.length === 0 ? (
                    ...
                    recentUnreadEmails.map((email) => (
                      <button
                        ...
                        className="mb-2 flex w-full items-start gap-3 rounded-lg border border-blue-100 bg-blue-50/70 px-3 py-3 text-left transition hover:bg-blue-50"
                      >
                ...
                {unreadEmailCount > 0 && (
                  <div className="border-t border-slate-100 px-4 py-2">
                    <button
                      ...
                      className="w-full rounded-md py-1.5 text-center text-xs font-medium text-blue-600 hover:bg-blue-50"
                    >
                      View all in inbox
                    </button>
                  </div>
