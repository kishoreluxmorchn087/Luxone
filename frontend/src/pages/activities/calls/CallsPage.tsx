        ...
        <div className="px-6 pt-4">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <IconOnlyButton icon={<List className="h-4 w-4 text-blue-600" />} />
            ...
            <div className="p-4">
              ...
              <div className="relative mt-4">
                ...
                <input
                  ...
                  placeholder="Search"
                  className="w-full rounded-md border border-slate-300 py-2 pl-9 pr-3 text-sm text-slate-700 outline-none focus:border-blue-500"
                />
              </div>
