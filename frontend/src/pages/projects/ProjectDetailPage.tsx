          ...
          {project.source_module && project.source_record_id ? (
            <div className="mt-4 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-slate-700">
              ...
              {getSourceRoute(project) ? (
                <Link to={getSourceRoute(project)!} className="mt-2 inline-flex text-sm font-medium text-blue-700 hover:underline">
                  Open source record
                </Link>
              ) : null}
            </div>
                ...
                <div className="flex flex-col gap-3">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-200"
                    />
                  </div>
...
function EditableTasksTable({
  ...
  const inputCls = "w-full rounded border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-500";
